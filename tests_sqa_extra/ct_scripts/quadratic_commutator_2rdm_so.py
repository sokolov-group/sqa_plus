#    file:  quadratic_commutator_2rdm_so.py
#  author:  Eric Neuscamman
#    date:  March 31, 2009
# summary:  Computes tensor contractions for [[H,A],A]_(1,2)
#
...
# Decompose 4ops
sqa.decomp_4ops_to_2ops_2rdms_so(result, d1aa, d1bb, d2aaaa, d2bbbb, d2baba)
...
#con_code += 'endheader\n'
#con_code += '\n'
#con_code += 'subroutine f_ct_quad_comm_opalg_so\n'
#con_code += '\n'
