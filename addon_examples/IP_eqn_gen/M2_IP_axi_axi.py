...
for t in effH:
  print t
term1 = sqa.term(1.0, [], [sqa.creOp(a),sqa.desOp(x),sqa.desOp(i)])
term2 = sqa.term(1.0, [], [sqa.creOp(j),sqa.creOp(y),sqa.desOp(b)])
print term1, term2
#
...
sqa.generateEinsum(term6, 'M[saxi:faxi, saxi:faxi]', 'AXIBYJ')
#
##################################################################
