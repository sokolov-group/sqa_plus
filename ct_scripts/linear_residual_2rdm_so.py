#    file:  linear_residual_2rdm_so.py
#  author:  Eric Neuscamman
#    date:  March 31, 2009
# summary:  Computes tensor contractions for <[H,r]>_(1,2)
#
...
sqa.decomp_3rdms_to_2rdms_so(result, rdm_dummy_name, d1aa, d1bb, d2aaaa, d2bbbb, d2baba)
...
#con_code += 'endheader\n'
#con_code += '\n'
#con_code += 'subroutine f_ct_res_opalg_so\n'
#con_code += '\n'
