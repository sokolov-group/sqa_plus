#    file:  quadratic_residual_3rdm_so.py
#  author:  Eric Neuscamman
#    date:  March 31, 2009
# summary:  Computes tensor contractions for <[[H,A],r]>_(1,2,(3))
#
...
# Decompose 4RDMs
sqa.decomp_4rdms_to_3rdms_so(result, d4name, d1aa, d1bb, d2aaaa, d2bbbb, d2baba, d3aaaaaa, d3bbbbbb, d3baabaa, d3abbabb)
...
#con_code += 'endheader\n'
#con_code += '\n'
#con_code += 'subroutine f_ct_quad_res_3rdm_opalg_so\n'
#con_code += '\n'
