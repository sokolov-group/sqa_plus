...
# External indices
x = sqa.index('xx', [tg_a], True)
y = sqa.index('yy', [tg_a], True)
z = sqa.index('zz', [tg_a], True)
i = sqa.index('ii', [tg_c], True)
j = sqa.index('jj', [tg_c], True)
k = sqa.index('kk', [tg_c], True)
a = sqa.index('aa', [tg_v], True)
b = sqa.index('bb', [tg_v], True)
c = sqa.index('cc', [tg_v], True)
...
#
   ...
   noterms.extend(t_no)
#for t in noterms:
#   print "Normal order",t
#
print ""
print "Normal ordering terms are:"
print ""
for t in noterms:
...
#print ""
for t in noterms:
   print "Normal ordering with respect to Core for the term:"
   print t
   coreterm = sqa.normalOrderCore(t)
   print "--------------------------------------------"
