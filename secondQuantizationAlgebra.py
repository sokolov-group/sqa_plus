...
#
# Collects the various functions associated with the
# second quantization algebra code for easy importing,
# as in "import secondQuantizationAlgebra.py as sqa".
#
...
from sqaMatrixBlock import matrixBlock, \
  dummyLabel,                     \
  filterVirtual,                  \
  filterCore,                     \
  normalOrderCore,                \
