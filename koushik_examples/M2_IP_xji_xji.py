...
for t in effH:
  print t
term1 = sqa.term(1.0, [], [sqa.creOp(x),sqa.desOp(j),sqa.desOp(i)])
term2 = sqa.term(1.0, [], [sqa.creOp(k),sqa.creOp(l),sqa.desOp(y)])
print term1, term2
#
...
sqa.generateEinsum(term6, 'M[sxji:fxji, sxji:fxji]', 'XJIYLK')
#
##################################################################
