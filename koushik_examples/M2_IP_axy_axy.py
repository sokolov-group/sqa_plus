...
for t in effH:
  print t
term1 = sqa.term(1.0, [], [sqa.creOp(a),sqa.desOp(x),sqa.desOp(y)])
term2 = sqa.term(1.0, [], [sqa.creOp(w),sqa.creOp(z),sqa.desOp(b)])
print term1, term2
#
...
sqa.generateEinsum(term6, 'M[saxy:faxy, saxy:faxy]', 'AXYBZW')
#
##################################################################
