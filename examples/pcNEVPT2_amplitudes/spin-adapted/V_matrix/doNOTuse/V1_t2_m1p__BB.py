...
sqa_plus.options.print_header("Spin-Adapted V(X,A)")
...
a_b = sqa_plus.index('A', [tg_beta, tg_vir])

terms_l_op = sqa_plus.term(-0.5, [], [sqa_plus.creOp(x_b), sqa_plus.desOp(a_b)])
...
result = sqa_plus.genEinsum(expected_V1_sa, 'V1', 'XA')
