...
###t2_ce had a prefactor of -0.5, should this be the same here?
terms_l_op = sqa_plus.term(1.0, [], [sqa_plus.creOp(x_a), sqa_plus.desOp(y_a)])

print(terms_l_op)

terms_Heff = sqa_plus.Heff(2)

# Multiply
print("\n## Multiply...")
terms_V_H = []
for _term in terms_Heff:
    terms_V_H.append(sqa_plus.multiplyTerms(terms_l_op, _term))

# Normal Order
print("\n## Normal ordering...")
terms_V1 = []
for _term in terms_V_H:
    term_normalOrdered = sqa_plus.normalOrder(_term)
    terms_V1.extend(term_normalOrdered)

print("\n## Computing matrix block...")
...
result = sqa_plus.genEinsum(expected_terms_V1_sa, 'V1', 'XY')
