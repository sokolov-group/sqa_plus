...
sqa_plus.options.print_header("Spin-Adapted V(I,X)")
...
term_l_op = sqa_plus.term(-0.5, [], [sqa_plus.creOp(i_a), sqa_plus.desOp(x_a)])
...
for selected_amplitude in amplitudes_list:
    ...
    expected_terms_V1_sa = sqa_plus.convertSpinIntegratedToAdapted(expected_terms_V1, remove_5rdms = False)
...
result = sqa_plus.genEinsum(expected_V1, 'V1', 'IX', remove_core_integrals = True)
