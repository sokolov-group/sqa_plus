...
terms = []
terms += [sqa.term(1.0, [], [h_t, x_op, y_op] + h_op + [w_op, z_op])]
terms += [sqa.term(-1.0, [], [h_t, x_op, y_op, w_op, z_op] + h_op)]
terms += [sqa.term(0.25, [], [v_t, x_op, y_op] + v_op + [w_op, z_op])]
terms += [sqa.term(-0.25, [], [v_t, x_op, y_op, w_op, z_op] + v_op)]
