...
terms = []
terms += [sqa.term(1.0, [], h_t + h_op + y_op + x_op)]
terms += [sqa.term(-1.0, [], h_t + y_op + h_op + x_op)]
terms += [sqa.term(0.25, [], v_t + v_op + y_op + x_op)]
terms += [sqa.term(-0.25, [], v_t + y_op + v_op + x_op)]
terms += [sqa.term(1.0, [], h_t + x_op + h_op + y_op)]
terms += [sqa.term(-1.0, [], h_t + x_op + y_op + h_op)]
terms += [sqa.term(0.25, [], v_t + x_op + v_op + y_op)]
terms += [sqa.term(-0.25, [], v_t + x_op + y_op + v_op)]
