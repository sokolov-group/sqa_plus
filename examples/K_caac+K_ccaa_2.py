...
terms += [sqa.term(1.0, [], h_t + x_op + h_op + ywz_op)]
terms += [sqa.term(-1.0, [], h_t + x_op + ywz_op + h_op)]
terms += [sqa.term(0.25, [], v_t + x_op + v_op + ywz_op)]
terms += [sqa.term(-0.25, [], v_t + x_op + ywz_op + v_op)]
