...
indices_string = 'ccee_ccee'
spin_indices_string = 'baab'

sqa_plus.options.print_header("Spin-Adapted CVS-EE: M11 H0 {:} ({:})".format(indices_string.upper(), spin_indices_string))
...
if indices_string_right in ['caaa']:
    ...
    terms_right = [sqa_plus.term(0.5, [], [sqa_plus.creOp(y_alpha), sqa_plus.creOp(z_alpha), sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(y_alpha), sqa_plus.creOp(z_beta),  sqa_plus.desOp(x_beta),  sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(y_alpha), sqa_plus.creOp(z_beta),  sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_beta)])]

elif indices_string_right in ['caea']:
    r_ind = 'IXAY'

    terms_right = [sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(y_alpha), sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(y_beta),  sqa_plus.desOp(x_beta),  sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(y_beta),  sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_beta)])]

elif indices_string_right in ['ccaa']:
    r_ind = 'IJXY'

    terms_right = [sqa_plus.term(0.25,[], [sqa_plus.creOp(x_alpha), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(x_alpha), sqa_plus.creOp(y_beta), sqa_plus.desOp(j_beta), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(x_alpha), sqa_plus.creOp(y_beta), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_beta)]),

                   sqa_plus.term(0.25,[], [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_beta), sqa_plus.desOp(j_beta), sqa_plus.desOp(i_beta)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_beta)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_beta), sqa_plus.desOp(i_alpha)])]


elif indices_string_right in ['cvaa']:
    r_ind = 'IJXY'

    terms_right = [sqa_plus.term(0.5, [], [sqa_plus.creOp(x_alpha), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(x_alpha), sqa_plus.creOp(y_beta),  sqa_plus.desOp(j_val_beta),  sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(x_alpha), sqa_plus.creOp(y_beta),  sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_beta)])]

elif indices_string_right in ['ccea']:
    r_ind = 'IJAX'

    terms_right = [sqa_plus.term(0.5, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_alpha), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_beta),  sqa_plus.desOp(j_beta),  sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_beta),  sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_beta)])]

elif indices_string_right in ['cvea']:
    r_ind = 'IJAX'

    terms_right = [sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_beta),  sqa_plus.desOp(j_val_beta),  sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_beta),  sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_beta)])]

elif indices_string_right in ['ccee']:
    r_ind = 'IJAB'

    terms_right = [sqa_plus.term(0.25, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_alpha), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0,  [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_beta),  sqa_plus.desOp(j_beta),  sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0,  [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_beta),  sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_beta)]),

                   sqa_plus.term(0.25, [], [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_beta), sqa_plus.desOp(j_beta), sqa_plus.desOp(i_beta)]),
                   sqa_plus.term(1.0,  [], [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_alpha),  sqa_plus.desOp(j_alpha),  sqa_plus.desOp(i_beta)]),
                   sqa_plus.term(1.0,  [], [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_alpha),  sqa_plus.desOp(j_beta), sqa_plus.desOp(i_alpha)])]

elif indices_string_right in ['cvee']:
    r_ind = 'IJAB'

    terms_right = [sqa_plus.term(0.5, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_beta),  sqa_plus.desOp(j_val_beta),  sqa_plus.desOp(i_alpha)])]

elif indices_string_right in ['caee']:
    r_ind = 'IJAB'

    terms_right = [sqa_plus.term(0.5, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_alpha), sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_beta), sqa_plus.desOp(x_beta), sqa_plus.desOp(i_alpha)]),
                   sqa_plus.term(1.0, [], [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_beta), sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_beta)])]


indices_string = indices_string + '_' + spin_indices_string
final_indices_string = l_ind + r_ind
...
result = sqa_plus.genEinsum(expected_EE_M11_sa, 'M_' + indices_string, final_indices_string, use_cvs_tensors = True, rm_core_int = True)
