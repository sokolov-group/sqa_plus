...
indices_string = 'cvaa_cvaa'
spin_indices_string = 'aaaa'
...
#CVEE
    ...
    if spin_indices_string == 'aaaa':
        ...
        term_left  = sqa_plus.term(1.0, [], [sqa_plus.creOp(k_beta), sqa_plus.creOp(l_val_alpha), sqa_plus.desOp(d_beta), sqa_plus.desOp(c_alpha)]) 
...
if indices_string_right in ['caaa']:
    ...
    #X_tensor_baab = [sqa_plus.tensor('X_abab', [i_beta,  x_alpha, y_alpha, z_beta],  [])]

    #X_tensor_bbbb = [sqa_plus.tensor('X_aaaa', [i_beta,  x_beta,  y_beta, z_beta],  X_sym_2)]
    #X_tensor_baba = [sqa_plus.tensor('X_abab', [i_beta,  x_alpha, y_beta, z_alpha], [])]
    ...
    terms_right = [sqa_plus.term(1.0, [], X_tensor_aaaa + [sqa_plus.creOp(a_alpha), sqa_plus.creOp(y_alpha), sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_alpha)]),
                  ...
                  sqa_plus.term(1.0, [], X_tensor_bbbb + [sqa_plus.creOp(a_beta), sqa_plus.creOp(y_beta), sqa_plus.desOp(x_beta), sqa_plus.desOp(i_beta)]),
                  sqa_plus.term(1.0, [], X_tensor_baba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(y_alpha), sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_beta)]),
                  sqa_plus.term(1.0, [], X_tensor_abba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(y_alpha), sqa_plus.desOp(x_beta), sqa_plus.desOp(i_alpha)])]

elif indices_string_right in ['ccaa']:
    X_tensor_aaaa = [sqa_plus.tensor('X_aaaa', [i_alpha, j_alpha, x_alpha, y_alpha], X_sym_3)]
    X_tensor_abab = [sqa_plus.tensor('X_abab', [i_alpha, j_beta,  x_alpha, y_beta],  X_sym_3)]
    ...
    X_tensor_baba = [sqa_plus.tensor('X_abab', [i_beta,  j_alpha, x_beta, y_alpha], X_sym_3)]
    ...
    terms_right = [sqa_plus.term(0.25,[], X_tensor_aaaa + [sqa_plus.creOp(x_alpha), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_alpha)]),
                  ...
                  sqa_plus.term(0.25,[], X_tensor_bbbb + [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_beta), sqa_plus.desOp(j_beta), sqa_plus.desOp(i_beta)]),
                  sqa_plus.term(1.0, [], X_tensor_baba + [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_beta)])]
                  #sqa_plus.term(1.0, [], X_tensor_abba + [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_beta), sqa_plus.desOp(i_alpha)])]
    ...
    X_tensor_baab = [sqa_plus.tensor('X_abab', [i_beta,  j_val_alpha, y_beta,  x_alpha],  [])]
    ...
    terms_right = [sqa_plus.term(0.5, [], X_tensor_aaaa + [sqa_plus.creOp(x_alpha), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_alpha)]),
                  ...
                  sqa_plus.term(0.5, [], X_tensor_bbbb + [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_beta), sqa_plus.desOp(j_val_beta), sqa_plus.desOp(i_beta)])]
                  #sqa_plus.term(1.0, [], X_tensor_baba + [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_beta)])]
                  #sqa_plus.term(1.0, [], X_tensor_abba + [sqa_plus.creOp(x_beta), sqa_plus.creOp(y_alpha), sqa_plus.desOp(j_val_beta), sqa_plus.desOp(i_alpha)])]
    ...
    #X_tensor_baba = [sqa_plus.tensor('X_abab', [i_beta,  j_alpha, a_beta, x_alpha], [])]
    #X_tensor_abba = [sqa_plus.tensor('X_abab', [i_alpha, j_beta,  a_beta, x_alpha], [])]
    ...
    terms_right = [sqa_plus.term(0.5, [], X_tensor_aaaa + [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_alpha), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_alpha)]),
                  ...
                  #sqa_plus.term(1.0, [], X_tensor_baab + [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_beta), sqa_plus.desOp(j_alpha), sqa_plus.desOp(i_beta)]),
     
                  sqa_plus.term(0.5, [], X_tensor_bbbb + [sqa_plus.creOp(a_beta), sqa_plus.creOp(x_beta), sqa_plus.desOp(j_beta), sqa_plus.desOp(i_beta)]),
                  ...
                  #sqa_plus.term(1.0, [], X_tensor_abba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(x_alpha), sqa_plus.desOp(j_beta), sqa_plus.desOp(i_alpha)])]
    ...
    X_tensor_bbbb = [sqa_plus.tensor('X_bbbb', [i_beta,  j_val_beta,  a_beta, x_beta],  [])]
    X_tensor_baba = [sqa_plus.tensor('X_abab', [i_beta,  j_val_alpha, a_beta, x_alpha], [])]
    X_tensor_abba = [sqa_plus.tensor('X_baab', [i_alpha, j_val_beta,  a_beta, x_alpha], [])]
    ...
    terms_right = [sqa_plus.term(1.0, [], X_tensor_aaaa + [sqa_plus.creOp(a_alpha), sqa_plus.creOp(x_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_alpha)]),
                  ...
                  sqa_plus.term(1.0, [], X_tensor_bbbb + [sqa_plus.creOp(a_beta), sqa_plus.creOp(x_beta), sqa_plus.desOp(j_val_beta), sqa_plus.desOp(i_beta)]),
                  sqa_plus.term(1.0, [], X_tensor_baba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(x_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_beta)]),
                  sqa_plus.term(1.0, [], X_tensor_abba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(x_alpha), sqa_plus.desOp(j_val_beta), sqa_plus.desOp(i_alpha)])]

elif indices_string_right in ['ccee']:
    X_sym_4 = [sqa_plus.symmetry((1,0,3,2), 1)]
    ## adding in [sqa_plus.symmetry((1,0,3,2), 1)] symm for aaaa & abab does not change results
    X_tensor_aaaa = [sqa_plus.tensor('X_aaaa', [i_alpha, j_alpha, a_alpha, b_alpha], X_sym_3+X_sym_4)]
    X_tensor_abab = [sqa_plus.tensor('X_abab', [i_alpha, j_beta,  a_alpha, b_beta], X_sym_4)]
    #X_tensor_baab = [sqa_plus.tensor('X_abab', [i_beta,  j_alpha, a_alpha, b_beta],  [])]

    X_tensor_bbbb = [sqa_plus.tensor('X_bbbb', [i_beta,  j_beta,  a_beta, b_beta],  X_sym_3+X_sym_4)]
    #X_tensor_baba = [sqa_plus.tensor('X_abab', [i_beta,  j_alpha, a_beta, b_alpha], [])]
    #X_tensor_abba = [sqa_plus.tensor('X_abab', [i_alpha, j_beta,  a_beta, b_alpha], [])]
    ...
    #X_tensor_baab = [sqa_plus.tensor('X_baab', [i_beta,  j_val_alpha, a_alpha, b_beta],  [])]

    X_tensor_bbbb = [sqa_plus.tensor('X_bbbb', [i_beta,  j_val_beta,  a_beta, b_beta],  X_sym_2)]
    #X_tensor_baba = [sqa_plus.tensor('X_abab', [i_beta,  j_val_alpha, a_beta, b_alpha], [])]
    #X_tensor_abba = [sqa_plus.tensor('X_baab', [i_alpha, j_val_beta,  a_beta, b_alpha], [])]
    ...
    terms_right = [sqa_plus.term(0.5, [], X_tensor_aaaa + [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_alpha)]),
                  ...
                  #sqa_plus.term(1.0, [], X_tensor_baab + [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_beta), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_beta)]),
     
                  sqa_plus.term(0.5, [], X_tensor_bbbb + [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_beta), sqa_plus.desOp(j_val_beta), sqa_plus.desOp(i_beta)])]
                  #sqa_plus.term(1.0, [], X_tensor_baba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_alpha), sqa_plus.desOp(j_val_alpha), sqa_plus.desOp(i_beta)])]
                  #sqa_plus.term(1.0, [], X_tensor_abba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_alpha), sqa_plus.desOp(j_val_beta), sqa_plus.desOp(i_alpha)])]
    ...
    X_tensor_bbbb = [sqa_plus.tensor('X_bbbb', [i_beta,  x_beta,  a_beta, b_beta],  X_sym_2)]
    ...
    terms_right = [sqa_plus.term(0.5, [], X_tensor_aaaa + [sqa_plus.creOp(a_alpha), sqa_plus.creOp(b_alpha), sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_alpha)]),
                   ...
                   sqa_plus.term(0.5, [], X_tensor_bbbb + [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_beta), sqa_plus.desOp(x_beta), sqa_plus.desOp(i_beta)])]
                   #sqa_plus.term(1.0, [], X_tensor_baba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_alpha), sqa_plus.desOp(x_alpha), sqa_plus.desOp(i_beta)])]
                   #sqa_plus.term(1.0, [], X_tensor_abba + [sqa_plus.creOp(a_beta), sqa_plus.creOp(b_alpha), sqa_plus.desOp(x_beta), sqa_plus.desOp(i_alpha)])]
