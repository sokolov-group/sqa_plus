...
if indices_string_left in ['caaa']:
    ...
    if spin_indices_string == 'aaaa':
    ...
    elif spin_indices_string == 'abab': ##abab
        ...
        term_left = sqa_plus.term(1.0, [], [sqa_plus.creOp(k_beta), sqa_plus.creOp(w_alpha), sqa_plus.desOp(z_alpha), sqa_plus.desOp(y_beta)])

    elif spin_indices_string == 'bbbb': ##bbbb
        term_left = sqa_plus.term(1.0, [], [sqa_plus.creOp(k_beta), sqa_plus.creOp(w_beta), sqa_plus.desOp(z_beta), sqa_plus.desOp(y_beta)])
    ...
    if spin_indices_string == 'aaaa':
        ...
        term_left = sqa_plus.term(1.0, [], [sqa_plus.creOp(k_beta), sqa_plus.creOp(w_beta), sqa_plus.desOp(z_beta), sqa_plus.desOp(b_beta)])

    elif spin_indices_string == 'baba':
        term_left = sqa_plus.term(1.0, [], [sqa_plus.creOp(k_beta), sqa_plus.creOp(w_alpha), sqa_plus.desOp(z_alpha), sqa_plus.desOp(b_beta)]) 

    elif spin_indices_string == 'abba':
        term_left = sqa_plus.term(1.0, [], [sqa_plus.creOp(k_alpha), sqa_plus.creOp(w_beta), sqa_plus.desOp(z_alpha), sqa_plus.desOp(b_beta)]) 
...
##expected_EE_M01.sort()
##
### Generating Numpy einsum equations
##result = sqa_plus.genEinsum(expected_EE_M01, 'sigma_' + indices_string, final_indices_string, use_cvs_tensors = True, rm_core_int = True)
##
##end = time.time()
