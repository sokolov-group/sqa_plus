...
#    X_tensor_baab = [sqa_plus.tensor('X_baba', [i_beta,  x_alpha, z_beta, y_alpha], [])]
    ...
    X_sym = [sqa_plus.symmetry((1,0,3,2), 1)]

    X_tensor_aaaa = [sqa_plus.tensor('X_aaaa', [i_alpha, j_alpha, x_alpha, y_alpha], X_sym_3+X_sym)]
    X_tensor_abab = [sqa_plus.tensor('X_abab', [i_alpha, j_beta,  x_alpha, y_beta],  X_sym)]

    #X_tensor_baab = [sqa_plus.tensor('X_abab', [i_beta,  j_alpha, x_alpha, y_beta],  [])]
    X_tensor_bbbb = [sqa_plus.tensor('X_bbbb', [i_beta,  j_beta,  x_beta, y_beta],  X_sym_3+X_sym)]
    ...
    X_tensor_bbbb = [sqa_plus.tensor('X_abab', [i_beta,  j_beta,  a_beta, x_beta],  X_sym_1)]
...
expected_EE_M01 = convert_X_si_to_sa(expected_EE_M01, sqa_plus.options, bare = False)
