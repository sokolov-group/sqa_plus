...
if indices_string in ['q_ca']:
    ...
    Y_abab = sqa_plus.tensor('Y_KWCU__abab', [r, k_beta,  w_beta,  c_alpha, u_beta])
    Y_baab = sqa_plus.tensor('Y_KWCU__baab', [r, k_beta,  w_beta,  c_alpha, u_beta])

    Y_bbbb = sqa_plus.tensor('Y_KWCU__aaaa', [r, k_beta,  w_beta,  c_beta, u_beta])
    Y_baba = sqa_plus.tensor('Y_KWCU__abab', [r, k_beta,  w_alpha, c_beta, u_alpha])
    Y_abba = sqa_plus.tensor('Y_KWCU__baab', [r, k_alpha, w_beta,  c_beta, u_alpha])
