...
terms = []
terms += [sqa.term(1.0, [], [h_t, x_des] + h_op + [y_cre])]
terms += [sqa.term(-1.0, [], [h_t, x_des, y_cre] + h_op)]
terms += [sqa.term(0.25, [], [v_t, x_des] + v_op + [y_cre])]
terms += [sqa.term(-0.25, [], [v_t, x_des, y_cre] + v_op)]
