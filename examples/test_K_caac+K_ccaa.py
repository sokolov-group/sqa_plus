...
terms += [sqa.term(1.0, [], h_t + h_op + ywz_op + xx_op)]
terms += [sqa.term(-1.0, [], h_t + ywz_op + h_op + xx_op)]
terms += [sqa.term(0.25, [], v_t + v_op + ywz_op + xx_op)]
terms += [sqa.term(-0.25, [], v_t + ywz_op + v_op + xx_op)]
terms += [sqa.term(1.0, [], h_t + xx_op + h_op + ywz_op)]
terms += [sqa.term(-1.0, [], h_t + xx_op + ywz_op + h_op)]
terms += [sqa.term(0.25, [], v_t + xx_op + v_op + ywz_op)]
terms += [sqa.term(-0.25, [], v_t + xx_op + ywz_op + v_op)]
