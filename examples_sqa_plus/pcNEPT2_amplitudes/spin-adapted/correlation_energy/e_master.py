...
if amplitude_string == 't1_0':
    ...
    t1_aaaa = sqa_plus.tensor("t1", [i_alpha, j_alpha, a_alpha, b_alpha], t1_symm_ppqq)
    t1_abab = sqa_plus.tensor("t1", [i_alpha, j_beta,  a_alpha, b_beta],  t1_symm_ppqq)
    t1_abba = sqa_plus.tensor("t1", [i_alpha, j_beta,  a_beta,  b_alpha], t1_symm_ppqq)
    t1_baba = sqa_plus.tensor("t1", [i_beta,  j_alpha, a_beta,  b_alpha], t1_symm_ppqq)
    t1_baab = sqa_plus.tensor("t1", [i_beta,  j_alpha, a_alpha, b_beta],  t1_symm_ppqq)
    t1_bbbb = sqa_plus.tensor("t1", [i_beta,  j_beta,  a_beta,  b_beta],  t1_symm_ppqq)

    terms_t = [sqa_plus.term(0.25, [], [t1_aaaa, cre_a_alpha, cre_b_alpha, des_j_alpha, des_i_alpha]),
               sqa_plus.term(0.25, [], [t1_abab, cre_a_alpha, cre_b_beta,  des_j_beta,  des_i_alpha]),
               sqa_plus.term(0.25, [], [t1_abba, cre_a_alpha, cre_b_beta,  des_j_alpha, des_i_beta]),
               sqa_plus.term(0.25, [], [t1_baba, cre_a_beta,  cre_b_alpha, des_j_alpha, des_i_beta]),
               sqa_plus.term(0.25, [], [t1_baab, cre_a_beta,  cre_b_alpha, des_j_beta,  des_i_alpha]),
    ...
    t1_aaaa = sqa_plus.tensor("t1", [i_alpha, x_alpha, a_alpha, y_alpha], t1_symm_pqrs)
    t1_abab = sqa_plus.tensor("t1", [i_alpha, x_beta,  a_alpha, y_beta],  t1_symm_pqrs)
    t1_abba = sqa_plus.tensor("t1", [i_alpha, x_beta,  a_beta,  y_alpha], t1_symm_pqrs)
    t1_baba = sqa_plus.tensor("t1", [i_beta,  x_alpha, a_beta,  y_alpha], t1_symm_pqrs)
    t1_baab = sqa_plus.tensor("t1", [i_beta,  x_alpha, a_alpha, y_beta],  t1_symm_pqrs)
    t1_bbbb = sqa_plus.tensor("t1", [i_beta,  x_beta,  a_beta,  y_beta],  t1_symm_pqrs)
    ...
    t1_aaaa = sqa_plus.tensor("t1", [i_alpha, x_alpha, a_alpha, b_alpha], t1_symm_pqrr)
    t1_abab = sqa_plus.tensor("t1", [i_alpha, x_beta,  a_alpha, b_beta],  t1_symm_pqrr)
    t1_abba = sqa_plus.tensor("t1", [i_alpha, x_beta,  a_beta,  b_alpha], t1_symm_pqrr)
    t1_baba = sqa_plus.tensor("t1", [i_beta,  x_alpha, a_beta,  b_alpha], t1_symm_pqrr)
    t1_baab = sqa_plus.tensor("t1", [i_beta,  x_alpha, a_alpha, b_beta],  t1_symm_pqrr)
    t1_bbbb = sqa_plus.tensor("t1", [i_beta,  x_beta,  a_beta,  b_beta],  t1_symm_pqrr)

    terms_t = [sqa_plus.term(0.5, [], [t1_aaaa, cre_a_alpha, cre_b_alpha, des_x_alpha, des_i_alpha]),
               sqa_plus.term(0.5, [], [t1_abab, cre_a_alpha, cre_b_beta,  des_x_beta,  des_i_alpha]),
               sqa_plus.term(0.5, [], [t1_abba, cre_a_beta,  cre_b_alpha, des_x_beta,  des_i_alpha]),
               sqa_plus.term(0.5, [], [t1_baba, cre_a_beta,  cre_b_alpha, des_x_alpha, des_i_beta]),
               sqa_plus.term(0.5, [], [t1_baab, cre_a_alpha, cre_b_beta,  des_x_alpha, des_i_beta]),
    ...
    t1_aaaa = sqa_plus.tensor("t1", [i_alpha, j_alpha, a_alpha, x_alpha], t1_symm_ppqr)
    t1_abab = sqa_plus.tensor("t1", [i_alpha, j_beta,  a_alpha, x_beta],  t1_symm_ppqr)
    t1_abba = sqa_plus.tensor("t1", [i_alpha, j_beta,  a_beta,  x_alpha], t1_symm_ppqr)
    t1_baba = sqa_plus.tensor("t1", [i_beta,  j_alpha, a_beta,  x_alpha], t1_symm_ppqr)
    t1_baab = sqa_plus.tensor("t1", [i_beta,  j_alpha, a_alpha, x_beta],  t1_symm_ppqr)
    t1_bbbb = sqa_plus.tensor("t1", [i_beta,  j_beta,  a_beta,  x_beta],  t1_symm_ppqr)

    terms_t = [sqa_plus.term(0.5, [], [t1_aaaa, cre_a_alpha, cre_x_alpha, des_j_alpha, des_i_alpha]),
               sqa_plus.term(0.5, [], [t1_abab, cre_a_alpha, cre_x_beta,  des_j_beta,  des_i_alpha]),
               sqa_plus.term(0.5, [], [t1_abba, cre_a_beta,  cre_x_alpha, des_j_beta,  des_i_alpha]),
               sqa_plus.term(0.5, [], [t1_baba, cre_a_beta,  cre_x_alpha, des_j_alpha, des_i_beta]),
               sqa_plus.term(0.5, [], [t1_baab, cre_a_alpha, cre_x_beta,  des_j_alpha, des_i_beta]),
    ...
    t1_aaaa = sqa_plus.tensor("t1", [x_alpha, y_alpha, a_alpha, b_alpha], t1_symm_ppqq)
    t1_abab = sqa_plus.tensor("t1", [x_alpha, y_beta,  a_alpha, b_beta],  t1_symm_ppqq)
    t1_abba = sqa_plus.tensor("t1", [x_alpha, y_beta,  a_beta,  b_alpha], t1_symm_ppqq)
    t1_baba = sqa_plus.tensor("t1", [x_beta,  y_alpha, a_beta,  b_alpha], t1_symm_ppqq)
    t1_baab = sqa_plus.tensor("t1", [x_beta,  y_alpha, a_alpha, b_beta],  t1_symm_ppqq)
    t1_bbbb = sqa_plus.tensor("t1", [x_beta,  y_beta,  a_beta,  b_beta],  t1_symm_ppqq)

    terms_t = [sqa_plus.term(0.25, [], [t1_aaaa, cre_a_alpha, cre_b_alpha, des_y_alpha, des_x_alpha]),
               sqa_plus.term(0.25, [], [t1_abab, cre_a_alpha, cre_b_beta,  des_y_beta,  des_x_alpha]),
               sqa_plus.term(0.25, [], [t1_abba, cre_a_beta,  cre_b_alpha, des_y_beta,  des_x_alpha]),
               sqa_plus.term(0.25, [], [t1_baba, cre_a_beta,  cre_b_alpha, des_y_alpha, des_x_beta]),
               sqa_plus.term(0.25, [], [t1_baab, cre_a_alpha, cre_b_beta,  des_y_alpha, des_x_beta]),
    ...
    t1_aaaa = sqa_plus.tensor("t1", [i_alpha, j_alpha, x_alpha, y_alpha], t1_symm_ppqq)
    t1_abab = sqa_plus.tensor("t1", [i_alpha, j_beta,  x_alpha, y_beta],  t1_symm_ppqq)
    t1_abba = sqa_plus.tensor("t1", [i_alpha, j_beta,  x_beta,  y_alpha], t1_symm_ppqq)
    t1_baba = sqa_plus.tensor("t1", [i_beta,  j_alpha, x_beta,  y_alpha], t1_symm_ppqq)
    t1_baab = sqa_plus.tensor("t1", [i_beta,  j_alpha, x_alpha, y_beta],  t1_symm_ppqq)
    t1_bbbb = sqa_plus.tensor("t1", [i_beta,  j_beta,  x_beta,  y_beta],  t1_symm_ppqq)

    terms_t = [sqa_plus.term(0.25, [], [t1_aaaa, cre_x_alpha, cre_y_alpha, des_j_alpha, des_i_alpha]),
               sqa_plus.term(0.25, [], [t1_abab, cre_x_alpha, cre_y_beta,  des_j_beta,  des_i_alpha]),
               sqa_plus.term(0.25, [], [t1_abba, cre_x_beta,  cre_y_alpha, des_j_beta,  des_i_alpha]),
               sqa_plus.term(0.25, [], [t1_baba, cre_x_beta,  cre_y_alpha, des_j_alpha, des_i_beta]),
               sqa_plus.term(0.25, [], [t1_baab, cre_x_alpha, cre_y_beta,  des_j_alpha, des_i_beta]),
    ...
    t2_aaaa = sqa_plus.tensor("t1", [x_alpha, y_alpha, a_alpha, z_alpha], t1_symm_ppqr)
    t2_abab = sqa_plus.tensor("t1", [x_alpha, y_beta,  a_alpha, z_beta],  t1_symm_ppqr)
    t2_abba = sqa_plus.tensor("t1", [x_alpha, y_beta,  a_beta,  z_alpha], t1_symm_ppqr)
    t2_baba = sqa_plus.tensor("t1", [x_beta,  y_alpha, a_beta,  z_alpha], t1_symm_ppqr)
    t2_baab = sqa_plus.tensor("t1", [x_beta,  y_alpha, a_alpha, z_beta],  t1_symm_ppqr)
    t2_bbbb = sqa_plus.tensor("t1", [x_beta,  y_beta,  a_beta,  z_beta],  t1_symm_ppqr)
    ...
    op_t2_baba = [t2_baba, cre_a_beta,  cre_z_alpha, des_y_alpha, des_x_beta]
    op_t2_baab = [t2_baab, cre_a_alpha, cre_z_beta,  des_y_alpha, des_x_beta]
    op_t2_bbbb = [t2_bbbb, cre_a_beta,  cre_z_beta,  des_y_beta,  des_x_beta]

    terms_t = [sqa_plus.term( 1.00, [], op_t1_aa),
               sqa_plus.term( 1.00, [], op_t1_bb),
               sqa_plus.term( 0.50, [], op_t2_aaaa),
               sqa_plus.term( 0.50, [], op_t2_abab),
               sqa_plus.term( 0.50, [], op_t2_abba),
               sqa_plus.term( 0.50, [], op_t2_baba),
               sqa_plus.term( 0.50, [], op_t2_baab),
    ...
    t1_aaaa = sqa_plus.tensor("t1", [i_alpha, z_alpha, x_alpha, y_alpha], t1_symm_pqrr)
    t1_abab = sqa_plus.tensor("t1", [i_alpha, z_beta,  x_alpha, y_beta],  t1_symm_pqrr)
    t1_abba = sqa_plus.tensor("t1", [i_alpha, z_beta,  x_beta,  y_alpha], t1_symm_pqrr)
    t1_baba = sqa_plus.tensor("t1", [i_beta,  z_alpha, x_beta,  y_alpha], t1_symm_pqrr)
    t1_baab = sqa_plus.tensor("t1", [i_beta,  z_alpha, x_alpha, y_beta],  t1_symm_pqrr)
    t1_bbbb = sqa_plus.tensor("t1", [i_beta,  z_beta,  x_beta,  y_beta],  t1_symm_pqrr)
    ...
    op_t1_abba = [t1_abba, cre_x_beta,  cre_y_alpha, des_z_beta,  des_i_alpha]
    op_t1_baba = [t1_baba, cre_x_beta,  cre_y_alpha, des_z_alpha, des_i_beta]
    ...
    terms_t = [sqa_plus.term( 1.00, [], op_t1_aa),
               ...
               sqa_plus.term( 0.50, [], op_t1_abab),
               sqa_plus.term( 0.50, [], op_t1_abba),
               sqa_plus.term( 0.50, [], op_t1_baba),
               sqa_plus.term( 0.50, [], op_t1_baab),
...
terms_expected_e_sa.sort()
result = sqa_plus.genEinsum(terms_expected_e_sa, e_string, '', rm_core_int = True, suffix = '')
