...
def Tamplitude(order = 1, internal_excitations = True, only_excitations = False, only_deexcitations = False):
    ...
    def Tamplitude_spin_integrated(order, internal_excitations):
        ...
        T2_deex = term(-1.00, [], [t2_ten, creOp(cor_1), creOp(cor_2), desOp(vir_4), desOp(vir_3)])
        T_ex.append(T2_ex)
        T_deex.append(T2_deex)
        ...
        T2_deex = term(-1.00, [], [t2_ten, creOp(cor_1), creOp(cor_2), desOp(act_4), desOp(act_3)])
        T_ex.append(T2_ex)
        T_deex.append(T2_deex)
        ...
        T2_deex = term(-1.00, [], [t2_ten, creOp(act_1), creOp(act_2), desOp(vir_4), desOp(vir_3)])
        T_ex.append(T2_ex)
        T_deex.append(T2_deex)
    ...
    def Tamplitude_cvs_spin_integrated(order, internal_excitations):
        ...
        T2_deex = term(-0.50, [], [t2_ten, creOp(cor_1), creOp(cor_2), desOp(vir_4), desOp(vir_3)])
        T_ex.append(T2_ex)
        T_deex.append(T2_deex)
