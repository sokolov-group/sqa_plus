...
#TODO: Implement spin-integrated splict cases for CVS: dyallH_act, T, T variations and Heff
#TODO: Implement spin-integrated cases for CVS
#TODO: Implement spin-orbital for CVS
...
def dyallH(indices_lists, spin_integrated = False, explicit_spin_cases = True, cvs_indices = False):
...
def dyallH_act(indices_lists, spin_integrated = False, explicit_spin_cases = True, cvs_indices = False):
...
def Tamplitude(order = 1, indices_lists = None, spin_integrated = False, explicit_spin_cases = True, cvs_indices = False, internal_excit = True):
...
def Tamplitude_excitation(order = 1, indices_lists = None, spin_integrated = False, explicit_spin_cases = True, cvs_indices = False):
...
def Tamplitude_deexcitation(order = 1, indices_lists = None, spin_integrated = False, explicit_spin_cases = True):
    ...
    def Tamplitude_deexcitation_cvs_spin_integrated_explicit_cases(order, indices_lists, internal_excit):
...
def Vperturbation(indices_lists, spin_integrated = False, explicit_spin_cases = True, cvs_indices = False):
